...
public class FresnelPortalUtils {
    ...
    public static void writeDatasetInfo(Model model, DatasetInfo dataset, String namespace){              
        ...
        model.add(model.createStatement(datasetResource,
                ...
                model.createResource(FresnelPortalConstants._Dataset)));

        // dcterms:title
        if (!dataset.getTitle().equals("")) {
            model.add(model.createStatement(datasetResource,
                    model.createProperty(FresnelPortalConstants.DCTERMS_NAMESPACE_URI, FresnelPortalConstants._title),
        ...
        if (!dataset.getDescription().equals("")) {
            model.add(model.createStatement(datasetResource,
                    model.createProperty(FresnelPortalConstants.DCTERMS_NAMESPACE_URI, FresnelPortalConstants._description),
